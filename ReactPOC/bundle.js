...
/***/ function(module, exports, __webpack_require__) {
	...
	var _testData = __webpack_require__(159);
	
	var _DataTable2 = __webpack_require__(160);
	...
	function renderStopName(busStop) {
	    return React.createElement("span", { "style": { "backgroundColor": "red" } }, busStop.name);
	}
	
	var BusDataTable = function (_DataTable) {
	    _inherits(BusDataTable, _DataTable);
	
	    function BusDataTable() {
	        _classCallCheck(this, BusDataTable);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(BusDataTable).apply(this, arguments));
	    }
	...
	window.onload = function () {
	    ...
	    var settings = [{
	        ...
	        render: function render(data) {
	            return React.createElement("span", null, data.id);
	        },
	        ...
	        title: "Latitude",
	        render: function render(data) {
	            return React.createElement("span", null, data.lat);
	        },
	        compareFunction: function compareFunction(a, b) {
	            return a.lat - b.lat;
	        }
	        ...
	        title: "Longitude",
	        render: function render(data) {
	            return React.createElement("span", null, data.lng);
	        },
	        compareFunction: function compareFunction(a, b) {
	            return a.lng - b.lng;
	        }
	    }];
	    ReactDOM.render(React.createElement(BusDataTable, { "settings": settings, "data": _testData.testData }), root);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports) {
	    exports.testData = [{
	        ...
	        lat: 44.56777752,
	        lng: -123.2747184,
	        routeNames: ["1", "3", "5", "7", "8", "C1", "C1R", "C3", "NON", "NOSE", "NOSW"]
	    }, {
	        id: 10279,
	        ...
	        lat: 44.56623432,
	        lng: -123.2685299,
	        routeNames: ["1", "3", "5", "7", "8", "C1", "C1R", "C3", "CVA", "NON", "NOSE", "NOSW"]
	    }, {
	        id: 10298,
	        name: "NW Monroe Ave & SW 9th St",
	        lat: 44.56583555,
	        lng: -123.2670069,
	        routeNames: ["1", "2", "3", "5", "6", "7", "8", "C1", "C1R", "C3", "CVA", "NON", "NOSE", "NOSW"]
	    }, {
	        id: 10308,
	        ...
	        lat: 44.57095786,
	        lng: -123.2823536,
	        routeNames: ["1", "7", "C1R", "C3", "NON", "NOSW"]
	    }, {
	        id: 12412,
	        ...
	        lat: 44.56860822,
	        lng: -123.2777692,
	        routeNames: ["1", "7", "C1R", "C3", "NON"]
	    }, {
	        id: 12431,
	        name: "SW 26th St & SW A Ave",
	        lat: 44.55928582,
	        lng: -123.2795194,
	        routeNames: ["3", "8", "C3", "NOSE", "NOSW"]
	    }, {
	        id: 12449,
	        name: "NW Monroe Ave & NW Kings Blvd",
	        lat: 44.56795864,
	        ...
	        lat: 44.56740743,
	        lng: -123.2727211,
	        routeNames: ["1", "5", "7", "C1", "C1R", "C3", "NON"]
	    }, {
	        id: 12465,
	        name: "NW Monroe Ave & NW 11th St",
	        lat: 44.56663989,
	        lng: -123.2696009,
	        routeNames: ["1", "5", "7", "C1", "C1R", "C3"]
	    }, {
	        id: 12477,
	        ...
	        lat: 44.59056161,
	        lng: -123.2759268,
	        routeNames: ["1", "5", "C1", "NON"]
	    }, {
	        id: 14445,
	        name: "NW Kings Blvd & NW Circle Blvd",
	        lat: 44.5855873,
	        lng: -123.2761061,
	        routeNames: ["5", "C1R", "NON"]
	    }, {
	        id: 14450,
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, React) {
	    ...
	    var DataTable = function (_super) {
	        ...
	        DataTable.prototype.sortedData = function () {
	            var _this = this;
	            var compareFunction = function (a, b) {
	                return _this.state.sortColumn.compareFunction(a, b) * _this.state.sortDirection;
	            };
	            return this.state.sortColumn && this.state.sortColumn.compareFunction ? this.props.data.slice().sort(compareFunction) : this.props.data;
	        };
	        DataTable.prototype.setSortColumn = function (column) {
	            var sortDirection;
	        ...
	        DataTable.prototype.renderHeader = function (column) {
	            var _this = this;
	        ...
	        DataTable.prototype.render = function () {
	            var _this = this;
	            var headers = this.props.settings.map(function (column) {
	                return _this.renderHeader(column);
	            });
	            var rows = this.sortedData().map(function (row) {
	                var cells = _this.props.settings.map(function (column) {
	                    return React.createElement("td", null, column.render(row));
	                });
	                return React.createElement("tr", null, cells);
	            });
	            return React.createElement("table", null, React.createElement("thead", null, React.createElement("tr", null, headers)), React.createElement("tbody", null, rows));
	        };
	        return DataTable;
	    }(React.Component);
